...
export const issues = pgTable(
  "issues",
  {
    ...
    featureValueSetAt: timestamp("feature_value_set_at", { withTimezone: true }),
    featureValueSetBy: uuid("feature_value_set_by").references(() => agents.id),
  ...
  (table) => ({
    ...
    featureValueIdx: index("issues_feature_value_idx").on(table.companyId, table.featureValue),
