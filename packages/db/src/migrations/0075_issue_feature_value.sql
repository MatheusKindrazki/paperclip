ALTER TABLE "issues" ADD COLUMN "feature_value" text CHECK ("feature_value" IN ('high', 'medium', 'low') OR "feature_value" IS NULL);
...
ALTER TABLE "issues" ADD CONSTRAINT "issues_feature_value_set_by_agents_id_fk" FOREIGN KEY ("feature_value_set_by") REFERENCES "public"."agents"("id") ON DELETE SET NULL ON UPDATE no action;
